...
public class MainSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case MainPackage.MY_GAME_MAP_EDITOR: {
				MyGameMapEditor myGameMapEditor = (MyGameMapEditor)theEObject;
				T result = caseMyGameMapEditor(myGameMapEditor);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case MainPackage.EDITOR: {
				Editor editor = (Editor)theEObject;
				T result = caseEditor(editor);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case MainPackage.WINDOW: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>My Game Map Editor</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>My Game Map Editor</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseMyGameMapEditor(MyGameMapEditor object) {
		return null;
	}
